 ...
 */
@Validated
public interface BasePriceLimitCusRecordService {
  ...
  Iterable<PriceLimitCusRecordDTO> batchCreate(
  ...
  Iterable<PriceLimitCusRecordDTO> batchUpdate(
  ...
  PriceLimitCusRecordDTO getById(@ApiParam(value = "id", required = true) Long id)
      throws ServiceException;
  ...
  Iterable<PriceLimitCusRecordDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
