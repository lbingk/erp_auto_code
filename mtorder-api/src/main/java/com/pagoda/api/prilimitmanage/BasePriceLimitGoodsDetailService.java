 ...
 */
@Validated
public interface BasePriceLimitGoodsDetailService {
  ...
  PriceLimitGoodsDetailDTO create(
  ...
  Iterable<PriceLimitGoodsDetailDTO> batchCreate(
  ...
  PriceLimitGoodsDetailDTO update(
  ...
  Iterable<PriceLimitGoodsDetailDTO> batchUpdate(
  ...
  PriceLimitGoodsDetailDTO getById(@ApiParam(value = "id", required = true) Long id)
      throws ServiceException;
  ...
  Iterable<PriceLimitGoodsDetailDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
