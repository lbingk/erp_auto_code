...
@EntityFeature(
  ...
  requestUrl = "/SalConsignOutExceptionLogService/findBy",
...
public class SalConsignOutExceptionLogDTO extends AbstractDTO implements Serializable {
  ...
  public static class Getters {
    ...
    public static final Function<SalConsignOutExceptionLogDTO, Integer> _shipSeq =
        o -> o.getShipSeq();
    public static final Function<SalConsignOutExceptionLogDTO, java.util.Date> _consignTime =
        o -> o.getConsignTime();
    ...
    public static final Function<SalConsignOutExceptionLogDTO, java.util.Date> _auditTime =
        o -> o.getAuditTime();
