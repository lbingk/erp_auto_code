...
@EntityFeature(
  ...
  requestUrl = "/SalConsignReturnHeadService/findSalConsignReturnHeadList",
...
public class SalConsignReturnHeadDTO extends AbstractDTO implements Serializable {
  ...
  public static class Getters {
    ...
    public static final Function<SalConsignReturnHeadDTO, String> _seqno = o -> o.getSeqno();
    public static final Function<SalConsignReturnHeadDTO, Long> _entId = o -> o.getEntId();
    public static final Function<SalConsignReturnHeadDTO, Long> _arrOrgId = o -> o.getArrOrgId();
    public static final Function<SalConsignReturnHeadDTO, String> _arrOrgCode =
        o -> o.getArrOrgCode();
    public static final Function<SalConsignReturnHeadDTO, String> _arrOrgName =
        o -> o.getArrOrgName();
    public static final Function<SalConsignReturnHeadDTO, Long> _cusOrgId = o -> o.getCusOrgId();
    public static final Function<SalConsignReturnHeadDTO, String> _cusOrgCode =
        o -> o.getCusOrgCode();
    public static final Function<SalConsignReturnHeadDTO, String> _cusOrgName =
        o -> o.getCusOrgName();
    public static final Function<SalConsignReturnHeadDTO, Integer> _returnType =
        o -> o.getReturnType();
    public static final Function<SalConsignReturnHeadDTO, java.util.Date> _returnDate =
        o -> o.getReturnDate();
    public static final Function<SalConsignReturnHeadDTO, java.math.BigDecimal> _returnQty =
        o -> o.getReturnQty();
    public static final Function<SalConsignReturnHeadDTO, String> _transitLineNo =
    ...
    public static final Function<SalConsignReturnHeadDTO, Integer> _printCount =
        o -> o.getPrintCount();
    public static final Function<SalConsignReturnHeadDTO, String> _auditorCode =
        o -> o.getAuditorCode();
    public static final Function<SalConsignReturnHeadDTO, String> _auditorName =
        o -> o.getAuditorName();
    public static final Function<SalConsignReturnHeadDTO, java.util.Date> _auditTime =
        o -> o.getAuditTime();
    public static final Function<SalConsignReturnHeadDTO, String> _remark = o -> o.getRemark();
    public static final Function<SalConsignReturnHeadDTO, String> _note = o -> o.getNote();
  }
