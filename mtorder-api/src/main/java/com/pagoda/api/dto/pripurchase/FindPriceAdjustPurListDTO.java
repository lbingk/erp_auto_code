...
@ApiModel(value = "FindPriceAdjustPurListDTO", description = "查询调价单")
@EntityFeature(
  entityName = "FindPriceAdjustPurListDTO",
  persistent = false,
  requestUrl = "",
  tableMultiSelect = false
)
public class FindPriceAdjustPurListDTO implements Serializable {
  @FieldMeta(
    name = "effectDate",
    scene = "price",
    nameCN = "生效日期",
