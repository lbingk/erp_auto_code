 ...
 */
@Validated
public interface BasePriceCatalogSalDetailService {
  ...
  PriceCatalogSalDetailDTO create(
  ...
  Iterable<PriceCatalogSalDetailDTO> batchCreate(
  ...
  PriceCatalogSalDetailDTO update(
  ...
  Iterable<PriceCatalogSalDetailDTO> batchUpdate(
  ...
  PriceCatalogSalDetailDTO getById(@ApiParam(value = "id", required = true) Long id)
      throws ServiceException;
  ...
  Iterable<PriceCatalogSalDetailDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
