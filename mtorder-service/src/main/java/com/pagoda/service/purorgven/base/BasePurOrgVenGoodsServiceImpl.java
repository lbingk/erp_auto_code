...
public abstract class BasePurOrgVenGoodsServiceImpl
    implements BasePurOrgVenGoodsService, InitializingBean {
  ...
  @ApiOperation(value = "selectOrgVenGoodsAuthored", notes = "已授权供应商机构商品查询")
  @Override
  public Page<PurOrgVenGoodsDTO> selectOrgVenGoodsAuthored(
      ...
      throws ServiceException {
    try {
      return repository.selectOrgVenGoodsAuthored(
          venOrgId,
          orgOrgId,
          goodsClassName,
          goodsName,
