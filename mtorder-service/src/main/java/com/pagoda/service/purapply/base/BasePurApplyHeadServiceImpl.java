package com.pagoda.service.purapply.base;
 ...
 */
@Validated
public abstract class BasePurApplyHeadServiceImpl
    implements BasePurApplyHeadService, InitializingBean {
  ...
  @ApiOperation(value = "queryPurApplyByCondition", notes = "采购请购单单头条件查询")
  @Override
  public Page<QueryPurApplyByConditionDTO> queryPurApplyByCondition(
      @ApiParam("seqno") String seqno,
      ...
      throws ServiceException {
    try {
      return repository.queryPurApplyByCondition(
          seqno,
          recOrgId,
          goodsId,
          creatorCode,
