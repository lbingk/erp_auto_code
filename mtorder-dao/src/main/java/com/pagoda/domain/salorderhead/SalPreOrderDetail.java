...
@DynamicUpdate
@DynamicInsert
@Table(name = "`sal_pre_order_detail`")
@org.hibernate.annotations.Table(appliesTo = "`sal_pre_order_detail`", comment = "销售预订单明细表")
@SQLDelete(sql = "update `sal_pre_order_detail` set deleted = id where id = ? and version = ?")
@Where(clause = "deleted = 0")
@EntityListeners({AuditingEntityListener.class, PagodaEntityListener.class})
@EntityFeature(
  entityName = "SalPreOrderDetail",
  idField = "id",
  persistent = true,
  generationType = "auto",
  batchImport = true,
...
public class SalPreOrderDetail extends SalPreOrderDetailDTO implements Serializable {
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "BIGINT   COMMENT '预订单ID'"
  )
  ...
  @Column(
    name = "\"pre_order_seqno\"",
    nullable = true,
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(35)   COMMENT '预订单号[冗余]'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 6,
    columnDefinition = "decimal(18,10)   COMMENT '订货量'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 6,
    columnDefinition = "decimal(18,10)   COMMENT '审核数量'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 6,
    columnDefinition = "decimal(18,10)   COMMENT '库存数量'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "INTEGER   COMMENT '预订单明细状态[10:新录入,20:录入完成,30:已追加 40:已审核]'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "BIGINT   COMMENT '片区ID'"
  )
  private Long areaId;
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(35)   COMMENT '片区代码'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(60)   COMMENT '片区名称'"
  )
  ...
  static {
    ...
    mapperFactory
        .classMap(SalPreOrderDetail.class, SalPreOrderDetailDTO.class)
        .mapNulls(false)
   ...
   * @return
   */
  public static SalPreOrderDetail toExample() {
    SalPreOrderDetail example = new SalPreOrderDetail();
  ...
  public void setFeildValue(String fieldName, Object value)
    ...
    Field field = SalPreOrderDetail.class.getDeclaredField(fieldName);
    field.setAccessible(true);
    field.set(this, value);
  }

  public SalPreOrderDetailDTO toDTO() {
    return mapper.map(this, SalPreOrderDetailDTO.class);
  }

  public static SalPreOrderDetail convertDTO(SalPreOrderDetailDTO dto) {
    return mapper.map(dto, SalPreOrderDetail.class);
  }

  public static Iterable<SalPreOrderDetail> batchConvertDTO(Iterable<SalPreOrderDetailDTO> dtos) {
    List<SalPreOrderDetail> entities = new ArrayList<>();
    if (dtos != null) {
  ...
  public static Iterable<SalPreOrderDetailDTO> batchConvert(Iterable<SalPreOrderDetail> entities) {
    List<SalPreOrderDetailDTO> dtos = new ArrayList<>();
    if (entities != null) {
  ...
  public static Converter<SalPreOrderDetail, SalPreOrderDetailDTO> DTO_CONVERTER =
      new Converter<SalPreOrderDetail, SalPreOrderDetailDTO>() {

        @Override
        public SalPreOrderDetailDTO convert(SalPreOrderDetail source) {
          return source.toDTO();
        }
      };
}
