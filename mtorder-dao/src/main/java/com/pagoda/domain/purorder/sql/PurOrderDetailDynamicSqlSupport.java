...
public class PurOrderDetailDynamicSqlSupport {
  ...
  public static SqlColumn<java.math.BigDecimal> recInvQty = purOrderDetailTable.recInvQty;
  ...
  public static final class PurOrderDetailTable extends SqlTable {
    ...
    public final SqlColumn<java.math.BigDecimal> recInvQty =
        column("rec_inv_qty", JDBCType.DECIMAL);
