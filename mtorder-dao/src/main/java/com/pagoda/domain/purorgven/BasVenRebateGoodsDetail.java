...
@DynamicUpdate
@DynamicInsert
@Table(name = "`bas_ven_rebate_goods_detail`")
@org.hibernate.annotations.Table(
  appliesTo = "`bas_ven_rebate_goods_detail`",
  comment = "供应商返利商品明细表"
)
@SQLDelete(
  sql = "update `bas_ven_rebate_goods_detail` set deleted = id where id = ? and version = ?"
)
@Where(clause = "deleted = 0")
@EntityListeners({AuditingEntityListener.class, PagodaEntityListener.class})
@EntityFeature(
  entityName = "BasVenRebateGoodsDetail",
  idField = "id",
  persistent = true,
  generationType = "auto",
  batchImport = true,
...
public class BasVenRebateGoodsDetail extends BasVenRebateGoodsDetailDTO implements Serializable {
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "DATE   COMMENT '生效日期'"
  )
  ...
  static {
    ...
    mapperFactory
        .classMap(BasVenRebateGoodsDetail.class, BasVenRebateGoodsDetailDTO.class)
        .mapNulls(false)
  ...
  public BasVenRebateGoodsDetail() {}
   ...
   * @return
   */
  public static BasVenRebateGoodsDetail toExample() {
    BasVenRebateGoodsDetail example = new BasVenRebateGoodsDetail();
  ...
  public void setFeildValue(String fieldName, Object value)
    ...
    Field field = BasVenRebateGoodsDetail.class.getDeclaredField(fieldName);
    field.setAccessible(true);
    field.set(this, value);
  }

  public BasVenRebateGoodsDetailDTO toDTO() {
    return mapper.map(this, BasVenRebateGoodsDetailDTO.class);
  }

  public static BasVenRebateGoodsDetail convertDTO(BasVenRebateGoodsDetailDTO dto) {
    return mapper.map(dto, BasVenRebateGoodsDetail.class);
  }

  public static Iterable<BasVenRebateGoodsDetail> batchConvertDTO(
      Iterable<BasVenRebateGoodsDetailDTO> dtos) {
    List<BasVenRebateGoodsDetail> entities = new ArrayList<>();
    if (dtos != null) {
  ...
  public static Iterable<BasVenRebateGoodsDetailDTO> batchConvert(
      Iterable<BasVenRebateGoodsDetail> entities) {
    List<BasVenRebateGoodsDetailDTO> dtos = new ArrayList<>();
    if (entities != null) {
  ...
  public static Converter<BasVenRebateGoodsDetail, BasVenRebateGoodsDetailDTO> DTO_CONVERTER =
      new Converter<BasVenRebateGoodsDetail, BasVenRebateGoodsDetailDTO>() {

        @Override
        public BasVenRebateGoodsDetailDTO convert(BasVenRebateGoodsDetail source) {
          return source.toDTO();
        }
      };
}
