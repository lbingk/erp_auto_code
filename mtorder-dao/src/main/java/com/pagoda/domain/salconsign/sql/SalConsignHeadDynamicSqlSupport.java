...
public class SalConsignHeadDynamicSqlSupport {
  ...
  public static SqlColumn<java.math.BigDecimal> totalQty = salConsignHeadTable.totalQty;
  ...
  public static final class SalConsignHeadTable extends SqlTable {
    ...
    public final SqlColumn<java.math.BigDecimal> totalQty = column("total_qty", JDBCType.DECIMAL);
