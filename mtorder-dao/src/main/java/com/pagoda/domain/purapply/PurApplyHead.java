...
public class PurApplyHead extends PurApplyHeadDTO implements Serializable {
  ...
  @FieldMeta(
    name = "sourceType",
    scene = "",
    nameCN = "数据来源{1:手工录入,2:请购单}",
    comment = "数据来源{1:手工录入,2:请购单}",
    nameEN = "source_type",
    type = "整型",
    format = "",
    displayLen = 1,
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "INTEGER   COMMENT '数据来源{1:手工录入,2:请购单}'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(35)   COMMENT '当前审核用户代码'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(60)   COMMENT '当前审核用户名称'"
  )
