...
/**
 * PriceLimitGoodsDetail 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface PriceLimitGoodsDetailRepository
    extends PriceLimitGoodsDetailRepositoryCustom,
        PagodaJpaRepository<PriceLimitGoodsDetail, Long> {
