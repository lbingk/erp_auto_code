...
/**
 * PriceLimitCusRecord 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface PriceLimitCusRecordRepository
    extends PriceLimitCusRecordRepositoryCustom, PagodaJpaRepository<PriceLimitCusRecord, Long> {
