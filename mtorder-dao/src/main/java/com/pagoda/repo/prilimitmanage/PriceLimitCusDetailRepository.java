...
/**
 * PriceLimitCusDetail 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface PriceLimitCusDetailRepository
    extends PriceLimitCusDetailRepositoryCustom, PagodaJpaRepository<PriceLimitCusDetail, Long> {
