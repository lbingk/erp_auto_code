...
/**
 * PriceLimitOperaHead 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface PriceLimitOperaHeadRepository
    extends PriceLimitOperaHeadRepositoryCustom, PagodaJpaRepository<PriceLimitOperaHead, Long> {
