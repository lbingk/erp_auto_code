...
/**
 * PriceCatalogSalHead扩展数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface PriceCatalogSalHeadRepositoryCustom {
   ...
   * @return
   */
  List<PriceCatalogSalHeadDTO> findBy(
      @Param("code") String code,
      @Param("name") String name,
      @Param("balOrgOrgId") Long balOrgOrgId,
      @Param("balOrgOrgCode") String balOrgOrgCode,
   ...
   * @return
   */
  List<PriceCatalogSalHeadDTO> findByExample(@Param("example") PriceCatalogSalHead example);
   ...
   * @return
   */
  Page<PriceCatalogSalHeadDTO> findByBuilder(
   ...
   * @return
   */
  List<PriceCatalogSalHeadDTO> findByBuilder(@Param("builder") JpaQueryBuilder builder);
   ...
   * @return
   */
  Page<PriceCatalogSalHeadDTO> findByFuzzySearch(
   ...
   */
  Page<PriceCatalogSalHeadDTO> findByField(
   ...
   * @throws IllegalAccessException
   */
  List<PriceCatalogSalHeadDTO> findByField(
