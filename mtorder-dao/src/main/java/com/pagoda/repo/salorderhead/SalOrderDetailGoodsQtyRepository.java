...
/**
 * SalOrderDetailGoodsQty 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface SalOrderDetailGoodsQtyRepository
    extends SalOrderDetailGoodsQtyRepositoryCustom,
        PagodaJpaRepository<SalOrderDetailGoodsQty, Long> {
