 ...
 * @generated
 */
public interface PurOrgVenRepositoryCustom {
   ...
   * @return
   */
  List<PurOrgVenDTO> findByExample(@Param("example") PurOrgVen example);
   ...
   * @return
   */
  Page<PurOrgVenDTO> findByBuilder(
   ...
   * @return
   */
  List<PurOrgVenDTO> findByBuilder(@Param("builder") JpaQueryBuilder builder);
   ...
   * @return
   */
  Page<PurOrgVenDTO> findByFuzzySearch(
   ...
   * @throws IllegalAccessException
   */
  List<PurOrgVenDTO> findByField(@Param("fieldName") String fieldName, @Param("value") Object value)
      throws NoSuchFieldException, IllegalAccessException;
}
