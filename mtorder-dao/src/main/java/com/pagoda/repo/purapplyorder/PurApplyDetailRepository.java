...
/**
 * PurApplyDetail 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface PurApplyDetailRepository
    extends PurApplyDetailRepositoryCustom, PagodaJpaRepository<PurApplyDetail, Long> {
